...
source_manifests: operations__nist_continuity.md, platform__aws_well_architected.md, operations__google_sre.md
...
- Source manifests: `operations__nist_continuity.md`, `platform__aws_well_architected.md`, `operations__google_sre.md`
